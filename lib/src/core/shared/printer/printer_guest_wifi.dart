...
//
// class PrinterInvoiceGuestWifi {
//   final OrderSingleton orderModel;
//   final String? reportTitle;
//
//   PrinterInvoiceGuestWifi({required this.orderModel, this.reportTitle}) {}
//
...
//        wifiPrinter.printer.emptyLines(1);
//
//        wifiPrinter.printer.text("Guest Bill", styles: const PosStyles(width: PosTextSize.size1, align: PosAlign.center, bold: true));
//        wifiPrinter.printer.emptyLines(1);
