...
//
// class PrinterInvoiceKitchenAndBar {
...
//
//   PrinterInvoiceKitchenAndBar({required this.orderModel, required this.printAll, required this.printNew, required this.printKitchen, required this.printBar, this.newItemOrderPrint}) {
...
//     //          ?theOrderForPrint.orderSource=="kukd"? 'Delivery-${theOrderForPrint.v}':'Delivery Items'
//     //          : (theOrderForPrint.orderType == "Collection" && theOrderForPrint.orderStatus == '2')
//     //              ? theOrderForPrint.orderSource=="kukd"? 'Collection-${theOrderForPrint.v}':'Collection Items'
...
//     //
//     //
//     //  final String orderDateTime = theOrderForPrint.orderSource=="kukd"?'Order Date: ${DateFormat('dd-MM-yyyy').format(theOrderForPrint.createdAt)} ${DateFormat.Hm().format(theOrderForPrint.createdAt)}':'Order Date: ${DateFormat('dd-MM-yyyy').format(theOrderForPrint.orderDate)} ${DateFormat.Hm().format(theOrderForPrint.orderDate)}';
...
//     //  final String? paidby= theOrderForPrint.orderSource=="kukd"?kukdData.first['chosenPaymentType']=="1"?"PAID BY CASH":"PAID BY CARD":null;
...
//     await SunmiPrinter.printText(userInfo.restaurantInfo!.companyName.toString(), style: SunmiStyle(fontSize: SunmiFontSize.XL, align: SunmiPrintAlign.CENTER, bold: true));
...
//     await SunmiPrinter.lineWrap(1);
//     await SunmiPrinter.printText("Kitchen Print", style: SunmiStyle(fontSize: SunmiFontSize.MD, align: SunmiPrintAlign.CENTER, bold: false));
//     await SunmiPrinter.lineWrap(1);
