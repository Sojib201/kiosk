...
OrderSingleton orderSingletonFromJson(String str) => OrderSingleton.fromJson(json.decode(str));

String orderSingletonToJson(OrderSingleton data) => json.encode(data.toJson());

class OrderSingleton {
  // Singleton instance
  static final OrderSingleton _instance = OrderSingleton._internal();

  // Factory constructor to return the singleton instance
  factory OrderSingleton() {
    return _instance;
  }

  // Internal constructor
  OrderSingleton._internal();
  ...
  factory OrderSingleton.fromJson(Map<String, dynamic> json) {
    return OrderSingleton()
      ..status = json["status"] ?? ""
      ..orderData = json["order_data"] == null ? OrderData() : OrderData.fromJson(json["order_data"]);
  }
...
class OrderData {
  ...
  factory OrderData.fromJson(Map<String, dynamic> json) {
    return OrderData(
      ...
      serviceExpense: json["total_service_exp_amnt"] ?? 0.0,
      ...
      bookingInfo: json["booking_info"] == null ? BookingInfo() : BookingInfo.fromJson(json["booking_info"]),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      "total_tp": totalTp,
      "total_tax": totalTax,
      "total_service_exp_amnt": serviceExpense,
